...
LIB_C_FILES += $(FREERTOS_SOURCE)/portable/GCC/$(FREERTOS_PORT)/port.c
LIB_C_FILES += $(FREERTOS_SOURCE)/portable/MemMang/$(FREERTOS_HEAP).c
LIB_C_FILES += $(sort $(wildcard $(FREERTOS_SOURCE)/*.c))
