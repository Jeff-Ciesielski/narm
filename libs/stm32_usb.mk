...
#Audio
LIB_C_FILES += $(call valid_c_files,$(ST_USB_DEV_CLASS_BASE)/audio/src)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/audio/inc/

#CDC
LIB_C_FILES += $(call valid_c_files,$(ST_USB_DEV_CLASS_BASE)/cdc/src)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/cdc/inc/

#DFU
LIB_C_FILES += $(call valid_c_files,$(ST_USB_DEV_CLASS_BASE)/dfu/src)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/dfu/inc/

#HID
LIB_C_FILES += $(call valid_c_files,$(ST_USB_DEV_CLASS_BASE)/hid/src)
LIB_INCLUDES      += -I$(ST_USB_DEV_CLASS_BASE)/hid/inc/

#MSC
LIB_C_FILES += $(call valid_c_files,$(ST_USB_DEV_CLASS_BASE)/msc/src)
...
#Core libraries
LIB_C_FILES += $(call valid_c_files,$(ST_USB_HOST_BASE)/Core/src)
...
#HID
LIB_C_FILES += $(call valid_c_files,$(ST_USB_HOST_CLASS_BASE)/HID/src)
LIB_INCLUDES      += -I$(ST_USB_HOST_CLASS_BASE)/HID/inc/

#MSC
LIB_C_FILES += $(call valid_c_files,$(ST_USB_HOST_CLASS_BASE)/MSC/src)
...
LIB_C_FILES += $(call valid_c_files,$(ST_USB_OTG_BASE)/src)
